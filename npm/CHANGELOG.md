...
- e28d928: List the new Osmosis, Kava, Cosmos Hub and Celestia channels, and rename the legacy ones.
...
- 64d9ff9: Add antumbra's validator logo, completing the active set.
