...
var Pn = (s, e, n) => e in s ? Ln(s, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : s[e] = n;
var c = (s, e, n) => Pn(s, typeof e != "symbol" ? e + "" : e, n);
function f(s, e) {
  if (!s)
    throw new Error(e);
}
const Rn = 34028234663852886e22, Fn = -34028234663852886e22, Jn = 4294967295, Yn = 2147483647, Gn = -2147483648;
function ee(s) {
  if (typeof s != "number")
    throw new Error("invalid int 32: " + typeof s);
  if (!Number.isInteger(s) || s > Yn || s < Gn)
    throw new Error("invalid int 32: " + s);
}
function ge(s) {
  if (typeof s != "number")
    throw new Error("invalid uint 32: " + typeof s);
  if (!Number.isInteger(s) || s > Jn || s < 0)
    throw new Error("invalid uint 32: " + s);
}
function Ye(s) {
  if (typeof s != "number")
    throw new Error("invalid float 32: " + typeof s);
  if (Number.isFinite(s) && (s > Rn || s < Fn))
...
function Kn(s, e, n, t) {
  ...
  const a = (r = t == null ? void 0 : t.localName) !== null && r !== void 0 ? r : e.substring(e.lastIndexOf(".") + 1), o = {
    [a]: function(i) {
      s.util.initFields(this), s.util.initPartial(i, this);
    }
  }[a];
  return Object.setPrototypeOf(o.prototype, new b()), Object.assign(o, {
    ...
    fromBinary(i, l) {
      return new o().fromBinary(i, l);
    },
    fromJson(i, l) {
      return new o().fromJson(i, l);
    },
    fromJsonString(i, l) {
      return new o().fromJsonString(i, l);
    },
    equals(i, l) {
      return s.util.equals(o, i, l);
    }
  }), o;
}
function Wn() {
...
function ce(s, e, n) {
  for (let a = 0; a < 28; a = a + 7) {
    const o = s >>> a, i = !(!(o >>> 7) && e == 0), l = (i ? o | 128 : o) & 255;
    if (n.push(l), !i)
      return;
  }
  ...
  if (n.push((r ? t | 128 : t) & 255), !!r) {
    for (let a = 3; a < 31; a = a + 7) {
      const o = e >>> a, i = !!(o >>> 7), l = (i ? o | 128 : o) & 255;
      if (n.push(l), !i)
        return;
    }
    n.push(e >>> 31 & 1);
...
function Ie(s) {
  ...
  let t = 0, r = 0;
  function a(o, i) {
    const l = Number(s.slice(o, i));
    r *= n, t = t * n + l, t >= ne && (r = r + (t / ne | 0), t = t % ne);
  }
  return a(-24, -18), a(-18, -12), a(-12, -6), a(-6), e ? Xe(t, r) : Ae(t, r);
}
function Xn(s, e) {
  let n = Ae(s, e);
  const t = n.hi & 2147483648;
  t && (n = Xe(n.lo, n.hi));
  const r = We(n.lo, n.hi);
  return t ? "-" + r : r;
}
function We(s, e) {
  ...
  let a = n + t * 6777216 + r * 6710656, o = t + r * 8147497, i = r * 2;
  const l = 1e7;
  return a >= l && (o += Math.floor(a / l), a %= l), o >= l && (i += Math.floor(o / l), o %= l), i.toString() + qe(o) + qe(a);
}
function Zn(s, e) {
...
function $n() {
  ...
  if (typeof BigInt == "function" && typeof s.getBigInt64 == "function" && typeof s.getBigUint64 == "function" && typeof s.setBigInt64 == "function" && typeof s.setBigUint64 == "function" && (typeof process != "object" || typeof process.env != "object" || process.env.BUF_BIGINT_DISABLE !== "1")) {
    const r = BigInt("-9223372036854775808"), a = BigInt("9223372036854775807"), o = BigInt("0"), i = BigInt("18446744073709551615");
    return {
      zero: BigInt(0),
      supported: !0,
      parse(l) {
  ...
  return {
    ...
    enc(r) {
      return typeof r != "string" && (r = r.toString()), n(r), Ie(r);
    },
    uEnc(r) {
      return typeof r != "string" && (r = r.toString()), t(r), Ie(r);
    },
    dec(r, a) {
      return Xn(r, a);
    },
...
class es {
   ...
   */
  int32(e) {
    return ee(e), Ue(e, this.buf), this;
  }
  /**
   ...
   */
  sint32(e) {
    return ee(e), e = (e << 1 ^ e >> 31) >>> 0, Ue(e, this.buf), this;
  }
  /**
...
class ns {
  constructor(e, n) {
    this.varint64 = Wn, this.uint32 = _n, this.buf = e, this.len = e.length, this.pos = 0, this.view = new DataView(e.buffer, e.byteOffset, e.byteLength), this.textDecoder = n ?? new TextDecoder();
  }
  /**
...
let M = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""), me = [];
for (let s = 0; s < M.length; s++)
  me[M[s].charCodeAt(0)] = s;
me[45] = M.indexOf("+");
me[95] = M.indexOf("/");
const $e = {
  /**
  ...
  dec(s) {
    ...
    for (let i = 0; i < s.length; i++) {
      if (a = me[s.charCodeAt(i)], a === void 0)
        switch (s[i]) {
          case "=":
            r = 0;
          case `
...
function as(s, e, n) {
  ...
  for (const i of r)
    e.runtime.bin.readField(a, t.readerFactory(i.data), e.field, i.wireType, t);
  return o();
}
function os(s, e, n, t) {
  nn(e, s);
  ...
  let i = e.field;
  !i.opt && !i.repeated && (i.kind == "enum" || i.kind == "scalar") && (i = Object.assign(Object.assign({}, e.field), { opt: !0 })), e.runtime.bin.writeField(i, n, o, a);
...
function tn(s, e) {
  return J(e) || !s.fieldWrapper ? e : s.fieldWrapper.wrapField(e);
}
...
function ms(s) {
  return s ? Object.assign(Object.assign({}, Te), s) : Te;
}
    ...
    writeMessage(s, e) {
      ...
      try {
        for (r of n.fields.byNumber()) {
          ...
          const o = r.oneof ? s[r.oneof.localName].value : s[r.localName], i = Se(r, o, e);
          i !== void 0 && (t[e.useProtoFieldName ? r.name : r.jsonName] = i);
        }
        const a = e.typeRegistry;
        if (a != null && a.findExtensionFor)
          for (const o of n.runtime.bin.listUnknownFields(s)) {
            const i = a.findExtensionFor(n.typeName, o.no);
            if (i && en(s, i)) {
              const l = as(s, i, e), g = Se(i.field, l, e);
              g !== void 0 && (t[i.field.jsonName] = g);
            }
          }
      } catch (a) {
        const o = r ? `cannot encode field ${n.typeName}.${r.name} to JSON` : `cannot encode message ${n.typeName} to JSON`, i = a instanceof Error ? a.message : String(a);
        throw new Error(o + (i.length > 0 ? `: ${i}` : ""));
      }
      return t;
    },
    readScalar(s, e, n) {
      return X(s, e, n ?? R.BIGINT, !0);
    },
    writeScalar(s, e, n) {
...
function je(s, e, n, t, r) {
  ...
  if (n.repeated) {
    ...
    for (const i of e) {
      if (i === null)
        throw new Error(`cannot decode field ${r.typeName}.${n.name} from JSON: ${x(i)}`);
      switch (n.kind) {
        case "message":
          o.push(n.T.fromJson(i, t));
          break;
        case "enum":
          const l = le(n.T, i, t.ignoreUnknownFields, !0);
          l !== se && o.push(l);
          break;
        case "scalar":
          try {
            o.push(X(n.T, i, n.L, !0));
          } catch (g) {
            let d = `cannot decode field ${r.typeName}.${n.name} from JSON: ${x(i)}`;
    ...
    switch (n.oneof && (s = s[n.oneof.localName] = { case: a }, a = "value"), n.kind) {
      case "message":
        ...
        if (e === null && o.typeName != "google.protobuf.Value")
          return;
        let i = s[a];
        J(i) ? i.fromJson(e, t) : (s[a] = i = o.fromJson(e, t), o.fieldWrapper && !n.oneof && (s[a] = o.fieldWrapper.unwrapField(i)));
        break;
      case "enum":
...
function ls(s, e) {
  ...
  return X(s, e, R.BIGINT, !0).toString();
}
function X(s, e, n, t) {
  if (e === null)
    return t ? G(s, n) : ae;
  switch (s) {
    ...
    case m.UINT32:
      ...
      if (typeof e == "number" ? a = e : typeof e == "string" && e.length > 0 && e.trim().length === e.length && (a = Number(e)), a === void 0)
        break;
      return s == m.UINT32 || s == m.FIXED32 ? ge(a) : ee(a), a;
    case m.INT64:
    case m.SFIXED64:
    case m.SINT64:
...
function Se(s, e, n) {
  if (s.kind == "map") {
    ...
    switch (s.V.kind) {
      case "scalar":
        for (const [o, i] of r)
          t[o.toString()] = te(s.V.T, i);
        break;
      case "message":
        for (const [o, i] of r)
          t[o.toString()] = i.toJson(n);
        break;
      case "enum":
        const a = s.V.T;
        for (const [o, i] of r)
          t[o.toString()] = he(a, i, n.enumAsInteger);
        break;
    }
...
const Y = Symbol("@bufbuild/protobuf/unknown-fields"), Ne = {
  readUnknownFields: !0,
...
function ds(s) {
  return s ? Object.assign(Object.assign({}, Ne), s) : Ne;
}
function gs(s) {
...
function ps() {
  return {
    ...
    onUnknownField(s, e, n, t) {
      const r = s;
      Array.isArray(r[Y]) || (r[Y] = []), r[Y].push({ no: e, wireType: n, data: t });
    },
    readMessage(s, e, n, t, r) {
      const a = s.getType(), o = r ? e.len : e.pos + n;
      let i, l;
      for (; e.pos < o && ([i, l] = e.tag(), !(r === !0 && l == y.EndGroup)); ) {
        const g = a.fields.find(i);
        if (!g) {
          const d = e.skip(l, i);
          t.readUnknownFields && this.onUnknownField(s, i, l, d);
          continue;
        }
        He(s, e, g, l, t);
      }
...
function He(s, e, n, t, r) {
  ...
  switch (n.oneof && (s = s[n.oneof.localName], s.case != o && delete s.value, s.case = o, o = "value"), n.kind) {
    ...
    case "message":
      const g = n.T;
      a ? s[o].push(re(e, new g(), r, n)) : J(s[o]) ? re(e, s[o], r, n) : (s[o] = re(e, new g(), r, n), g.fieldWrapper && !n.oneof && !n.repeated && (s[o] = g.fieldWrapper.unwrapField(s[o])));
      break;
    case "map":
      let [d, p] = us(n, e, r);
      s[o][d] = p;
...
function us(s, e, n) {
  ...
  if (a === void 0 && (a = G(s.K, R.BIGINT)), typeof a != "string" && typeof a != "number" && (a = a.toString()), o === void 0)
    switch (s.V.kind) {
      case "scalar":
        o = G(s.V.T, R.BIGINT);
        break;
        ...
        if (o[r] != null)
          switch (t.kind) {
            case "oneof":
              ...
              if (i === void 0)
                continue;
              const l = t.findField(i);
              let g = o[r].value;
              l && l.kind == "message" && !J(g, l.T) ? g = new l.T(g) : l && l.kind === "scalar" && l.T === m.BYTES && (g = K(g)), a[r] = { case: i, value: g };
              break;
            case "scalar":
            case "enum":
              let d = o[r];
              t.T === m.BYTES && (d = t.repeated ? d.map(K) : K(d)), a[r] = d;
              break;
            case "map":
              switch (t.V.kind) {
                case "scalar":
                case "enum":
                  if (t.V.T === m.BYTES)
                    for (const [V, F] of Object.entries(o[r]))
                      a[r][V] = K(F);
                  else
                ...
                case "message":
                  const u = t.V.T;
                  for (const V of Object.keys(o[r])) {
                    let F = o[r][V];
                    u.fieldWrapper || (F = new u(F)), a[r][V] = F;
                  }
                  break;
              }
              break;
            case "message":
              const p = t.T;
              if (t.repeated)
                a[r] = o[r].map((u) => J(u, p) ? u : new p(u));
              else {
                const u = o[r];
                p.fieldWrapper ? /* We can't use BytesValue.typeName as that will create a circular import */ p.typeName === "google.protobuf.BytesValue" ? a[r] = K(u) : a[r] = u : a[r] = J(u, p) ? u : new p(u);
              }
              break;
          }
      }
    ...
    equals(s, e, n) {
      return e === n ? !0 : !e || !n ? !1 : s.fields.byMember().every((t) => {
        ...
        if (t.repeated) {
          ...
          switch (t.kind) {
            case "message":
              return r.every((o, i) => t.T.equals(o, a[i]));
            case "scalar":
              return r.every((o, i) => P(t.T, o, a[i]));
            case "enum":
              return r.every((o, i) => P(m.INT32, o, a[i]));
          }
        ...
        switch (t.kind) {
          ...
          case "oneof":
            ...
            switch (o.kind) {
              ...
              case "enum":
                return P(m.INT32, r.value, a.value);
              case "scalar":
                return P(o.T, r.value, a.value);
            }
            throw new Error(`oneof cannot contain ${o.kind}`);
          case "map":
            const i = Object.keys(r).concat(Object.keys(a));
            switch (t.V.kind) {
              case "message":
                const l = t.V.T;
                return i.every((d) => l.equals(r[d], a[d]));
              case "enum":
                return i.every((d) => P(m.INT32, r[d], a[d]));
              case "scalar":
                const g = t.V.T;
                return i.every((d) => P(g, r[d], a[d]));
            }
            break;
        }
      });
...
const Is = /* @__PURE__ */ new Set([
  ...
  "toObject"
]), mn = (s) => `${s}$`, Us = (s) => qs.has(s) ? mn(s) : s, zs = (s) => Is.has(s) ? mn(s) : s;
class Cs {
  constructor(e) {
...
function Ts(s, e) {
  ...
  for (const d of typeof s == "function" ? s() : s) {
    const p = d;
    if (p.localName = an(d.name, d.oneof !== void 0), p.jsonName = (n = d.jsonName) !== null && n !== void 0 ? n : As(d.name), p.repeated = (t = d.repeated) !== null && t !== void 0 ? t : !1, d.kind == "scalar" && (p.L = (r = d.L) !== null && r !== void 0 ? r : R.BIGINT), p.delimited = (a = d.delimited) !== null && a !== void 0 ? a : !1, p.req = (o = d.req) !== null && o !== void 0 ? o : !1, p.opt = (i = d.opt) !== null && i !== void 0 ? i : !1, d.packed === void 0 && (p.packed = d.kind == "enum" || d.kind == "scalar" && d.T != m.BYTES && d.T != m.STRING), d.oneof !== void 0) {
      const u = typeof d.oneof == "string" ? d.oneof : d.oneof.name;
      (!g || g.name != u) && (g = new Cs(u)), p.oneof = g, g.addField(p);
    }
    l.push(p);
  }
  return l;
...
class v extends b {
  ...
  fromJson(e, n) {
    ...
    if (a.startsWith("google.protobuf.") && Object.prototype.hasOwnProperty.call(e, "value"))
      i = o.fromJson(e.value, n);
    else {
      const l = Object.assign({}, e);
      delete l["@type"], i = o.fromJson(l, n);
    }
...
c(A, "runtime", h), c(A, "typeName", "penumbra.core.asset.v1.BalanceCommitment"), c(A, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "inner",
    kind: "scalar",
...
c(I, "runtime", h), c(I, "typeName", "penumbra.core.asset.v1.AssetId"), c(I, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "inner",
    kind: "scalar",
...
c(q, "runtime", h), c(q, "typeName", "penumbra.core.asset.v1.Denom"), c(q, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "denom",
    kind: "scalar",
...
c(U, "runtime", h), c(U, "typeName", "penumbra.core.asset.v1.Metadata"), c(U, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "description",
    kind: "scalar",
  ...
  { no: 1985, name: "images", kind: "message", T: ie, repeated: !0 },
  {
    no: 1986,
    name: "priority_score",
    kind: "scalar",
  ...
  { no: 1987, name: "badges", kind: "message", T: ie, repeated: !0 },
  {
    no: 1988,
    name: "coingecko_id",
    kind: "scalar",
...
c(z, "runtime", h), c(z, "typeName", "penumbra.core.asset.v1.DenomUnit"), c(z, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "denom",
    kind: "scalar",
...
c(C, "runtime", h), c(C, "typeName", "penumbra.core.asset.v1.Value"), c(C, "fields", h.util.newFieldList(() => [
  { no: 1, name: "amount", kind: "message", T: Q },
...
c(T, "runtime", h), c(T, "typeName", "penumbra.core.asset.v1.Balance"), c(T, "fields", h.util.newFieldList(() => [
...
c(j, "runtime", h), c(j, "typeName", "penumbra.core.asset.v1.Balance.SignedValue"), c(j, "fields", h.util.newFieldList(() => [
...
c(N, "runtime", h), c(N, "typeName", "penumbra.core.asset.v1.ValueView.KnownAssetId"), c(N, "fields", h.util.newFieldList(() => [
  { no: 1, name: "amount", kind: "message", T: Q },
...
c(O, "runtime", h), c(O, "typeName", "penumbra.core.asset.v1.ValueView.UnknownAssetId"), c(O, "fields", h.util.newFieldList(() => [
  { no: 1, name: "amount", kind: "message", T: Q },
  { no: 2, name: "asset_id", kind: "message", T: L }
]));
let we = O;
...
c(H, "runtime", h), c(H, "typeName", "penumbra.core.asset.v1.AssetImage"), c(H, "fields", h.util.newFieldList(() => [
  {
    no: 1,
    name: "png",
    kind: "scalar",
...
c(D, "runtime", h), c(D, "typeName", "penumbra.core.asset.v1.EquivalentValue"), c(D, "fields", h.util.newFieldList(() => [
  { no: 1, name: "equivalent_amount", kind: "message", T: Q },
...
}, Ss = (s) => s.toString(16).padStart(2, "0"), Ns = async (s) => {
  const e = await crypto.subtle.digest("SHA-256", s);
  return new Uint8Array(e);
}, cn = async (s) => {
  const n = new TextEncoder().encode(s), t = await Ns(n);
...
class ke {
  constructor(e) {
    ...
    c(this, "assetById", {});
    c(this, "assetByDenom", {});
    this.chainId = e.chainId, this.ibcConnections = e.ibcConnections, this.numeraires = e.numeraires.map((n) => new L({ inner: js(n) })), Object.entries(e.assetById).forEach(([n, t]) => {
  ...
  _resolveMetadata(e, n) {
    const t = de(e) ? this.assetByDenom[e.denom] : this.assetById[Re(e.inner)];
    if (!t && n) {
      const r = de(e) ? e.denom : Re(e.inner), a = de(e) ? "denom" : "asset id";
...
Made with ❤️`,
  ...
  ibcConnections: wn,
  numeraires: vn
}, Symbol.toStringTag, { value: "Module" })), kn = "penumbra-testnet-phobos-2", An = [
  {
    addressPrefix: "osmo",
    chainId: "osmo-test-5",
  ...
  ibcConnections: An,
  numeraires: qn
}, Symbol.toStringTag, { value: "Module" })), Un = "penumbra-testnet-phobos-3", zn = [
  {
    addressPrefix: "osmo",
    chainId: "osmo-test-5",
    channelId: "channel-2",
  ...
  ibcConnections: zn,
  numeraires: Tn
}, Symbol.toStringTag, { value: "Module" })), W = (s) => s, Fe = {
  "penumbra-testnet-deimos-8-x6de97e39": W(Hs),
  "penumbra-1": W(Es),
  "penumbra-testnet-phobos-1": W(Ms),
  "penumbra-testnet-phobos-2": W(Ps),
  "penumbra-testnet-phobos-3": W(Fs)
}, jn = [
  {
    name: "ghostinnet",
...
const Je = "https://raw.githubusercontent.com/penumbrafi/registry/main/registry";
class Qs {
  constructor(e) {
    this.options = e;
  }
  ...
  async fetchGlobals() {
    const e = await this.typedFetcher(`${Je}/globals.json`);
    return new Bn(e);
  }
...
class Vs {
  constructor(e, n) {
    c(this, "github");
    this.bundled = e, this.github = new Qs(n);
  }
  async get(e) {
    try {
...
class Ws {
  constructor(e) {
    c(this, "bundled");
    c(this, "remote");
    this.bundled = new Gs(), this.remote = new Vs(this.bundled, e);
  }
}
export {
  Ws as ChainRegistryClient,
  ke as Registry,
  de as isDenom
};
